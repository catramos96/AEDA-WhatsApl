...
\begin{DoxyCompactList}\small\item\em Funcao que converte a informacao do programa sobre grupos num ficheiro .txt. \end{DoxyCompactList}\end{DoxyCompactItemize}
