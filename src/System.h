...
/**
* @brief função indica se as datas estão dentro de três dias
* @param d1 (data mais antiga) e d2 (data mais atual)
* @return True se as datas estiverem com três dias de diferença, false caso não estejam
*/
